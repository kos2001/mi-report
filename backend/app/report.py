...
- 완결된 문장이 아니라 개조식으로 작성한다. 각 줄은 "- " 로 시작하는 불릿 하나이며,
  명사형으로 끝난다(예: '~상승', '~필요', '~부상'). "~다.", "~이다.", "~한다." 로
  끝나는 서술형 문장은 한 줄도 쓰지 마라.
- "이번 주 총평은", "정리하면", "종합하면" 같은 여는/닫는 설명 문장·문단을 앞뒤에 붙이지
  마라. 불릿 목록만 바로 출력한다 — 도입부·마무리 문장 없이 첫 줄부터 "- " 불릿이다.
- 출력은 평문(개조식 불릿 목록)만. JSON/코드펜스/머리말을 붙이지 않는다."""
